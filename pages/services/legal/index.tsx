        ...
        <section className={styles.services_main}>
          <div className={styles.services_main__path}>
            ...
            <Link href={`/services/legal`}>
              <a className={styles.services_main__path_text}>Услуги для юридических лиц</a>
            </Link>
          </div>
          <div className={styles.services_main__title}>
            <h1 className={styles.services_main__title_text}>Услуги для юридических лиц</h1>
            <div className={styles.services_main__title_icon}>
              <Image loader={() => "/services/icon-legal.svg?w=85"} src={"/services/icon-legal.svg"} width={85} height={72} alt="иконка" />
            </div>
          </div>
               ...
               <Link href={`/services/physical`}> 
                 <a className={styles.services_main__container_item}>
                   <div className={`${styles.services_main__container_item_img} ${styles.services_main__container_item_img_mini}`}>
                     <Image loader={() => `/services/icon-physical.svg?w=119`} src={`/services/icon-physical.svg`} width={100} height={90} alt="иконка" />
                   </div>
                   <p className={styles.services_main__container_item_text}>Услуги для физических лиц</p>
                 </a>
               </Link>
             </li>
          </ul>
